...
selected_indicators = c("Non Residential  Commercial Buildings  SAAR ","Non Residential  Commercial Buildings  NSA ","Industrial Production Value added output  As a percent of GDP",
                        "Steel price  Plate  A36  domestic Ex mill US Midwest   short ton  nominal","Manufacturing Gross output  sales   Nominal USD","Roofing Squares  MM ","Northeast total",
                        "Consumption  private  PPP exchange rate  nominal  US ","Imports  goods   services  PPP exchange rate  nominal  US",
